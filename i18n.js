...
const ADNOVA_EXTRA_TRANSLATIONS = {
  zh: {
    ...
    ad_result_price_prefix: '现价', ad_result_default_product: '产品', ad_result_default_goal: '转化目标', ad_result_shooting_template: '建议真人出镜，镜头顺序：痛点开场 → 方案展示 → 优惠强化 → CTA收尾。场景优先门店真实环境，搭配产品特写与客户互动镜头。',
  ...
  en: {
    ...
    ad_result_price_prefix: 'now at', ad_result_default_product: 'your product', ad_result_default_goal: 'conversion', ad_result_shooting_template: 'Use real-person footage. Shot order: hook in first 3 seconds → showcase solution → reinforce offer → close with CTA. Film in-store scenes with product close-ups and customer interactions.',
  ...
  ms: {
    ...
    ad_result_price_prefix: 'harga', ad_result_default_product: 'produk anda', ad_result_default_goal: 'konversi', ad_result_shooting_template: 'Gunakan model sebenar. Urutan rakaman: 3 saat pembukaan menarik → tunjuk penyelesaian → tekankan promosi → tutup dengan CTA. Rakaman di premis sebenar dengan close-up produk dan interaksi pelanggan.',
