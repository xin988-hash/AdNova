...
const ADNOVA_TRANSLATIONS = {
  zh: {
    ...
    dashboard_saved_ads: '已保存广告',
    dashboard_ad_publish: '广告发布',
    dashboard_billing: '账单',
    dashboard_account: '我的账号',
    ...
    login_welcome: '欢迎回来',
    login_subtitle: '请输入你的账号信息继续使用平台',
    login_email: '邮箱',
    login_password: '密码',
    login_forgot: '忘记密码？',
    ...
    register_terms: '注册即代表你同意平台服务条款与隐私政策。',
  ...
  en: {
    ...
    dashboard_overview: 'Overview', dashboard_ad_generate: 'AI Ad Generation', dashboard_saved_ads: 'Saved Ads', dashboard_ad_publish: 'Ad Publishing', dashboard_billing: 'Billing', dashboard_account: 'My Account', dashboard_resources: 'Ads',
    ...
    login_welcome: 'Welcome Back', login_subtitle: 'Enter your account information to continue', login_email: 'Email', login_password: 'Password',
    ...
    register_terms: 'By registering, you agree to the platform Terms of Service and Privacy Policy.', register_create: 'Create Your Account',
    ...
    workspace_main_desc: 'This next-step workspace uses white cards, purple gradients, generous rounding, and light shadows.',
  ...
  ms: {
    ...
    dashboard_overview: 'Gambaran Keseluruhan', dashboard_ad_generate: 'Penjanaan Iklan AI', dashboard_saved_ads: 'Iklan Disimpan', dashboard_ad_publish: 'Penerbitan Iklan', dashboard_billing: 'Bil', dashboard_account: 'Akaun Saya', dashboard_resources: 'Iklan',
    ...
    login_welcome: 'Selamat Kembali', login_subtitle: 'Masukkan maklumat akaun anda untuk teruskan', login_email: 'E-mel', login_password: 'Kata laluan',
    ...
    register_terms: 'Dengan mendaftar, anda bersetuju dengan Terma Perkhidmatan dan Polisi Privasi platform.', register_create: 'Cipta Akaun Anda',
